...
public class PromotionBLService_Driver {
    ...
    public void add() throws Exception {
        assertEquals(ResultMessage.SUCCESS, tested.add(new PromotionVO(PromotionType.HOTEL_PROMOTION, null, 0.9)));
    }

    @Test
    public void del() throws Exception {
        assertEquals(ResultMessage.SUCCESS, tested.del(new PromotionVO(PromotionType.HOTEL_PROMOTION, null, 0.9)));
    }

    @Test
    public void modify() throws Exception {
        assertEquals(ResultMessage.SUCCESS, tested.modify(new PromotionVO(PromotionType.HOTEL_PROMOTION, null, 0.9)));
    }
    ...
    private void printPromotionVO(PromotionVO promotionVO){
        ...
        System.out.println(promotionVO.promotionTimeVO.beginTime);
        System.out.println(promotionVO.promotionTimeVO.endTime);
